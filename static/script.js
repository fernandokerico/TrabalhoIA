...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (startTrainingBtn) {
        startTrainingBtn.addEventListener('click', () => {
            trainingStatus.textContent = 'Iniciando treinamento...';
            fetch('/iniciar_treinamento_com_pastas', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json' // Ou 'application/x-www-form-urlencoded' se você enviar dados de formulário
                },
                // Se você precisar enviar os nomes das pastas selecionadas,
                // você precisará construir um corpo (body) aqui.
